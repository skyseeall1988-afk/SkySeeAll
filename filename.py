...
export DATABASE_URL='postgresql://neondb_owner:npg_J7wHBUkb3Sml@ep-square-water-ade57wm7-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require'
​--- Configuration ---
​app = Flask(name)
...
data = request.json
if data.get('token') != 8194660112801103Nov03!:
